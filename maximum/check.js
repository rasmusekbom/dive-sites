...
const enMarkers = ['Book now', 'Fun dives', 'What is included', 'Questions & answers', 'How it works', 'Where we dive', 'All prices', 'per person', 'Book at least two'];
for (const p of pages) {
  ...
  if (['ko', 'ja', 'zh', 'de', 'fr'].includes(lang)) {
