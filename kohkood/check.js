...
const enMarkers = ['Book now', 'Details & booking', 'Frequently asked', 'What you\'ll see', 'Prerequisites', 'Included', 'How it works', 'Questions people ask', 'Good to know', 'Keep exploring', 'Weekly schedule', 'A typical day', 'Best value', 'Without equipment'];
for (const p of pages) {
  ...
  if (['de', 'fr', 'nl', 'sv', 'th', 'ru', 'zh'].includes(lang)) {
